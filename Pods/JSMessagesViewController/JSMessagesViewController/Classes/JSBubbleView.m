...
+ (CGSize)textSizeForText:(NSString *)txt withFrame:(CGRect)frame;
+ (CGSize)neededSizeForText:(NSString *)text withFrame:(CGRect)frame;
+ (CGFloat)neededHeightForText:(NSString *)text withFrame:(CGRect)frame;
...
- (CGRect)bubbleFrame
{
    CGSize bubbleSize = [JSBubbleView neededSizeForText:self.textView.text withFrame:[self frame]];
...
- (void)layoutSubviews
{
    ...
    CGRect textFrame = CGRectMake(textX + 1,
                                  self.bubbleImageView.frame.origin.y + 1,
...
+ (CGSize)textSizeForText:(NSString *)txt withFrame:(CGRect)frame
{
    CGFloat maxWidth = roundf(frame.size.width * 0.82f);
    ...
    if (NSFoundationVersionNumber > NSFoundationVersionNumber_iOS_6_0) {
        CGRect stringRect = [txt boundingRectWithSize:CGSizeMake(224.0f, CGFLOAT_MAX)
...
+ (CGSize)neededSizeForText:(NSString *)text withFrame:(CGRect)frame
{
    CGSize textSize = [JSBubbleView textSizeForText:text withFrame:frame];
...
+ (CGFloat)neededHeightForText:(NSString *)text withFrame:(CGRect)frame
{
    CGSize size = [JSBubbleView neededSizeForText:text withFrame:frame];
