...
- (void)configureSendButtonWithStyle:(JSMessageInputViewStyle)style
{
    ...
    if(style == JSMessageInputViewStyleClassic) {
        ...
        UIColor *color = [UIColor colorWithRed:23.0f/255.0f green:122.0f/255.0f blue:160.0f/255.0f alpha:1.0f];
        
        sendButton = [UIButton buttonWithType:UIButtonTypeCustom];
        sendButton.backgroundColor = [UIColor clearColor];
        
        [sendButton setTitleColor:color forState:UIControlStateNormal];
        [sendButton setTitleColor:color forState:UIControlStateHighlighted];
